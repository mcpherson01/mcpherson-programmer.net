	...
	<div class= "wrap" style="width: 60%;">
		...
		// Create the message which appears at the bottom of the settings page
			echo '<div style="padding: 30px; background-color: lightblue; margin: 50px 0; text-align: center;">
				<h1><span style="color: purple;">What is the Admin Page Spider Pro Pack?</span></h1>
				<br>
				<h1>THE PRO PACK FEATURES</h1>
				<br/>
				<a target="_blank" href="https://j7digital.com/downloads/admin-page-spider-pro-pack/" style="text-decoration: none;"><h3 style="background-color: darkslateblue; color: white; max-width: 300px; text-decoration: none; margin: auto; padding: 10px 20px; border-radius: 15px;">Learn More Here</h3></a></div>';
