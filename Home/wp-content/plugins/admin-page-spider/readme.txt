...
Add a neat dropdown menu with all your website's pages right in the Admin Bar. So you can view, edit & jump to any page instantly without going to the dashboard!
...
Yes, the Pro Pack simply adds support for additional plugins and their custom post types. So you only need the pro pack if you use those third party plugins and want menus for them.
